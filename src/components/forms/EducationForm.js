    ...
    return (
        <div className="education-form-wrapper">
            <form action="" className="education-form">
                ...
                <input type="date" name="startDate" id="education" placeholder='Start date' onChange={(e) => onChange(e, data.id)} value={data.startDate}/>
                <input type="date" name="endDate" id="education" placeholder='End date' onChange={(e) => onChange(e, data.id)} value={data.endDate}/>
